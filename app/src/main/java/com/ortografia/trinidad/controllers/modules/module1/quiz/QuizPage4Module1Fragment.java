...
public class QuizPage4Module1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_quiz_page4_module1, container, false);
    ...
    private void content() {
        ...
        String[] parameters = {"Acentuación","4"};
        ...
        try{
            ...
            txtTitle.setText(txtTitle.getText() + " 4");
    ...
    private boolean checkAnswer(){
        if(cbOption1.isChecked() && cbOption2.isChecked() && !cbOption3.isChecked() && cbOption4.isChecked() && !cbOption5.isChecked() && cbOption6.isChecked())
            return true;
        else
            return false;
    }
