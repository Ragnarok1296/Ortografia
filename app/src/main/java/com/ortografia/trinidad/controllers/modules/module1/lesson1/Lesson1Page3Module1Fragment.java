...
public class Lesson1Page3Module1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lesson1_page3_module1, container, false);
    ...
    private void content() {
        ...
        String[] parameters = {"Acentuación","Introducción","2"};
