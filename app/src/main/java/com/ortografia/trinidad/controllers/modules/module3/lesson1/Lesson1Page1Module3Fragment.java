...
public class Lesson1Page1Module3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lesson1_page1_module3, container, false);
    ...
    private void content() {
        ...
        String[] parameters = {"Puntuación","Punto","1"};
