...
public class Lesson1Page3Module3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lesson1_page3_module3, container, false);
    ...
    private void content() {
        ...
        String[] parameters = {"Puntuación","Punto","2"};
