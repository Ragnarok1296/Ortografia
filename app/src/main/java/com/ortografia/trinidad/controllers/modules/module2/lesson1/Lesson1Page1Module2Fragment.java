...
public class Lesson1Page1Module2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lesson1_page1_module2, container, false);
    ...
    private void content() {
        ...
        String[] parameters = {"Diferencias","G-J","1"};
