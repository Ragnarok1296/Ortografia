...
public class Lesson1Page3Module2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lesson1_page3_module2, container, false);
    ...
    private void content() {
        ...
        String[] parameters = {"Diferencias","G-J","2"};
