...
public class Lesson1Page5Module1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lesson1_page5_module1, container, false);
    ...
    private void content() {
        ...
        String[] parameters = {"Acentuación","Introducción","3"};
