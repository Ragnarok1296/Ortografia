...
public class QuizPage2Module1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_quiz_page2_module1, container, false);
    ...
    private void content() {
        ...
        String[] parameters = {"Acentuación","2"};
        ...
        try{
            ...
            txtTitle.setText(txtTitle.getText() + " 2");
    ...
    private boolean checkAnswer(){
        if(cbOption1.isChecked() && !cbOption2.isChecked() && !cbOption3.isChecked() && cbOption4.isChecked() && !cbOption5.isChecked())
            return true;
        else
            return false;
    }
